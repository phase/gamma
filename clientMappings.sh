...
java -XX:+UseG1GC -Xmx7G -jar lib/fernflower.jar "-dgs=1" "-hdc=0" "-asc=1" "-udv=0" "-din=1" "-rbr=0" "-rsy=1" "minecraft/b1_7_3_client_mapped.jar" "minecraft/src/" | awk '$4 ~ "minecraft" {printf "Decompiling %s\r", $4}'
